...
Curr_Components Clarke(Curr_Components Curr_Input)
{
  ...
  volatile s32 qIa_divSQRT3_tmp;
  volatile s32 qIb_divSQRT3_tmp ;
  
  volatile s16 qIa_divSQRT3;
  volatile s16 qIb_divSQRT3 ;
  ...
  qIa_divSQRT3_tmp=(-(qIa_divSQRT3_tmp)-(qIb_divSQRT3_tmp)-(qIb_divSQRT3_tmp));

  if (qIa_divSQRT3_tmp < S16_MIN) {
    qIa_divSQRT3_tmp = S16_MIN;
  } else  if (qIa_divSQRT3_tmp > S16_MAX) { 
    qIa_divSQRT3_tmp = S16_MAX;
  }
    
  //qIbeta = -(2*qIbs+qIas)/sqrt(3)
  Curr_Output.qI_Component2=qIa_divSQRT3_tmp;
...
Curr_Components Park(Curr_Components Curr_Input, s16 Theta)
{
  ...
  //both s16s then divided by 32768 can't overflow
  ...
  qIq_tmp_1 = qIq_tmp_1 - qIq_tmp_2;
  if (qIq_tmp_1 < S16_MIN) {
    qIq_tmp_1 = S16_MIN;
  } else  if (qIq_tmp_1 > S16_MAX) { 
    qIq_tmp_1 = S16_MAX;
  }
  
  //Iq component in Q1.15 Format 
  Curr_Output.qI_Component1 = qIq_tmp_1;
  ...
  qId_tmp_1 = qId_tmp_1 + qId_tmp_2;
  if (qId_tmp_1 < S16_MIN) {
    qId_tmp_1 = S16_MIN;
  } else  if (qId_tmp_1 > S16_MAX) { 
    qId_tmp_1 = S16_MAX;
  }
  
   //Id component in Q1.15 Format   
  Curr_Output.qI_Component2 = qId_tmp_1;  
